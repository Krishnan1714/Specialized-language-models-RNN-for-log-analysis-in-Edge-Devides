...
# ✅ Load Data
csv_path = "assets/logsummary.csv"
...
training_args = TrainingArguments(
    ...
    num_train_epochs=25,  # ✅ Increased for better generalization
    weight_decay=0.01,
    save_total_limit=2,
    save_strategy="epoch",
...
trainer.save_model("./t5_summarization_final_v2")
tokenizer.save_pretrained("./t5_summarization_final_v2")