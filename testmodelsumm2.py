...
# Explanation:
# - The create_sequences function now includes a check to ensure the dataset is large enough before segmentation.
# - If the dataset is too small, an error is raised, preventing unexpected behavior.
# - This prevents indexing errors and ensures that sequence-based processing is viable.
